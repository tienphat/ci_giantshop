	...
	<div class="container sign-in-show">
      <div class="row">
          ...
          <div class="col-md-3 login-form">
              ...
              <div class="sign-in">
                  <button type="submit" name="login" class="btn btn-danger sign-in-button btnLogin"><i class="sign-in-i fa fa-lock"></i>Đăng nhập</button>
		...
		<div class="row header-main">
			...
			<div class="col-md-5 col-sm-5 col-xs-9">
				<div class="form-search">
					<input type="text" class="search" placeholder="Nhập thông tin tìm kiếm">
