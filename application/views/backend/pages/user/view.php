<div class="show-table">
    <table class="table table-bordered table-hover" style="border: 1px solid gainsboro;">
        <thead>
            <tr>
                <th width="40px"><input type="checkbox" id="check"><button id="delete-all" onclick="delete_member('user')">Xoá</button></th>
                <th width="40px">ID</th>
                <th>Họ tên</th>
        ...
        <tbody>
            <?php foreach ($list as $row): ?>
                ...
                <tr>
                    ...
                    <td><button class='fa fa-trash-o fa-lg btnDelete-user' onclick="del_member('user', '<?php echo $id; ?>')" ></button></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
