<?php
    ...
    foreach ($list as $row) {
        ...
        $html_tbody.= "<tr>";
        $html_tbody.="<td>" . $id . "</td>";
        $html_tbody.="<td><a href='admin/category/update/$id'>" . $row['title'] . "</a></td>";
        $html_tbody.="<td>" . $row['link'] . "</td>";
        $html_tbody.="<td>" . $row['created'] . "</td>";
        $html_tbody.="<td>" . $row['created_by'] . "</td>";
        $html_tbody.="<td><a href='admin/category/delete/$id'><i class='fa fa-trash-o fa-lg'></i></a></td>";
        $html_tbody.="<td><a href='admin/category/restore/$id'><i class='fa fa-edit fa-lg'></i></a></td>";
        $html_tbody.="</tr>";
    }
?>
